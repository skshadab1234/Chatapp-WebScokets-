                    ...
                    <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                        ...
                        <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="auth/logout.php">Log out <i class="ri-logout-circle-r-line float-end text-muted"></i></a>
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <div>
                            ...
                            <div class="text-center border-bottom p-4">
                                <div class="mb-4 profile-user">
                                    <img src="https://themesbrand.com/chatvia/layouts/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
